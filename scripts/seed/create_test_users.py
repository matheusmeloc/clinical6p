"""
Script de População (Seed): create_test_users.py

Insere usuários fictícios no banco de dados para rodar testes ou simular
um ambiente de uso real durante o desenvolvimento.
"""
import asyncio
