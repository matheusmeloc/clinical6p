"""
Script de Migração: migration_alarm.py

Responsável por criar ou ajustar as tabelas/registros referentes ao sistema
de alarmes e notificações (como envio de e-mails em circunstâncias críticas).
"""
import sqlite3
import os
