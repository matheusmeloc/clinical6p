"""
Script de Migração: alter_db.py

Aplica alterações na estrutura (schema) do banco de dados.
Usado para adicionar colunas ou modificar tabelas sem perder os dados.
"""
import sqlite3
