    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <p className="text-xs text-slate-400">Usa o CPF como login no portal do paciente.</p>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.5fr_1fr]">
        <Card className="bg-white/90 border border-slate-200">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-slate-500 font-semibold">Pacientes</p>
        ...
        <Card className="bg-white/90 border border-slate-200">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-slate-500 font-semibold">Ações rápidas</p>
        ...
        {viewPatient && (
          <DialogContent onClose={() => setViewPatient(null)} className="max-w-2xl">
            ...
            <div className="space-y-6">
              {/* Dados pessoais */}
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 border-b border-slate-100 pb-1 mb-3">Dados pessoais</p>
              ...
              {/* Contato */}
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 border-b border-slate-100 pb-1 mb-3">Contato</p>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              {/* Atendimento */}
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 border-b border-slate-100 pb-1 mb-3">Atendimento</p>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                {viewPatient.observations && (
                  <div className="mt-3 rounded-xl bg-slate-50 border border-slate-200 p-3">
                    ...
                    <p className="text-sm text-slate-700 whitespace-pre-wrap">{viewPatient.observations}</p>
                  </div>
                )}
              </div>
            </div>
      ...
      <Card className="bg-white/90 border border-slate-200">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-slate-500 font-semibold">Lista de pacientes</p>
                ...
                {filteredPatients.length > 0 ? (
                  filteredPatients.map((p) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-slate-600 whitespace-nowrap">{formatCPF(p.cpf)}</td>
